...
import {px2dp} from "../../common/CommonDevice";
...
export default class Tab extends React.Component {
  ...
  render() {
    ...
    let tabStyle = [
      styles.container,Platform.OS=='ios'?{height:Layout.tabBarHeight}:{},
    ...
    return (
      <TouchableOpacity
        testID={this.props.testID}
        activeOpacity={Platform.OS=='ios'?1:this.props.hidesTabTouch ? 1.0 : 0.8}
        onPress={this._handlePress}
        style={tabStyle}>
        <View>
          {icon}
